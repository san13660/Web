    ...
    return (
      <div className='main'>
        ...
        <div className='slides'>
          ...
          <Slide type={'Video Game'} title={'This Cat of Mine'} img={tcom} description={'This prototype game is a 2D platformer with fun characters and a quirky story. Made during the Global Game Jam 2019.'} techs={['Unity 2D', 'C#']}/>
